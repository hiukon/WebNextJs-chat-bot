...
const ChatWindow = () => {
    ...
    return (
        <>
            ...
            <div className={`${styles.chatbotPopup} ${isChatbotOpen ? styles.showChatbot : ''}`}>
                <div className={styles.chatHeader}>
                    <div className={styles.headerInfo}>
                        <svg className={styles.chatbotLogo} xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 650 700">
                    ...
                    <button className={`${styles.closeChatbot} material-symbols-rounded`} onClick={() => setIsChatbotOpen(false)}>
                        keyboard_arrow_down
                    </button>
                </div>
                <MessageList />
