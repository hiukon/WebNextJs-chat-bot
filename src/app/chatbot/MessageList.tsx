        ...
        <div className={styles.chatBody}>
            {messages.map((msg, index) => (
                <div key={index} className={`${styles.message} ${msg.type === 'user' ? styles.userMessage : styles.botMessage}`}>
                    {msg.type === 'bot' && (
                        <svg className={styles.botAvatar} xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 650 700">
                    ...
                    {msg.file && <img src={`data:${msg.file.mime_type};base64,${msg.file.data}`} className={styles.attachment} />}
                </div>
            ))}
            {isThinking && (
